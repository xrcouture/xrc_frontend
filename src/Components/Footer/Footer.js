    ...
    <>
            ...
            <div className='footer-subscribe-form'>
              ...
              <Formik
                ...
                onSubmit={async (values, { setSubmitting }) => {
                  console.log(values)
                  await axios.post("https://api.metadrip.xrcouture.com/user/newsLetter", values, {
                    headers: {
      ...
      <div className='footer-container d-md-flex d-md-none'>
        ...
        <div className='footer-options-container col-md-8'>
          ...
          <div className='footer-options-container-two d-none d-md-block'>
            <div className='d-flex mt-4'>
              <a rel="noreferrer" href='https://www.facebook.com/xr.couture/' target="_blank" className='icons'>
                <FaFacebookF color='black' />
              </a>
              <a rel="noreferrer" href='https://www.instagram.com/xr.couture/?hl=en' target='_blank' className="icons">
                <AiFillInstagram color='black' />
              </a>
              <a rel="noreferrer" href='https://twitter.com/XRCouture' target='_blank' className='icons'>
                <FaTwitter color='black' />
              </a>
              <a rel="noreferrer" href='https://www.linkedin.com/company/xrcouture/' target="_blank" className='icons'>
                <FaLinkedinIn color="black" />
              </a>
              <a rel="noreferrer" href='https://tr.ee/nTjMdc6n0h' target='_blank' className='icons'>
                <FaDiscord color='black' />
              </a>
            </div>
            ...
            <div className='col-xs-6 col-sm-6 w-50'>
              <div className='footer-options-container-two d-md-none flex-column'>
                <div className='footer-links mt-5 d-sm-flex justify-content-start flex-column'>
                  <div className='mb-3'>
                    <a rel="noreferrer" href='https://web2.xrcouture.com/collections/web2' target='_blank' className='text-white text-decoration-none'>
                      Web2 Collection
                    </a>
                  </div>
                  <div className='mb-3'>
                    <a rel="noreferrer" href='https://metadrip.xrcouture.com/' target='_blank' className='text-white text-decoration-none'>
                      Web3 Collection
                    </a>
                  </div>
                  <div className='mb-3'>
